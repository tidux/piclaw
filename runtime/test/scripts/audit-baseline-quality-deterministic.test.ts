...
describe("audit-baseline-quality-deterministic", () => {
  ...
  test("list-groups exposes finer deterministic subgroup coverage", async () => {
    ...
    expect(lines).toContain("channels-web-agent-flow\t43\tchannels web agent flow");
    ...
    expect(lines).toContain("web-ui-interaction-and-state\t70\tweb ui interaction and state");
    expect(lines).toContain("web-ui-rendering-and-panes\t59\tweb ui rendering and panes");
