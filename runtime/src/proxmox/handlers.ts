...
export function getStoredProxmoxConfig(chatJid: string): ProxmoxConfig | null {
  return getProxmoxConfig(chatJid);
}

export async function setStoredProxmoxConfig(
  chatJid: string,
  config: Omit<ProxmoxConfig, "chat_jid" | "created_at" | "updated_at">,
): Promise<ProxmoxConfigSetResult> {
...
export async function clearStoredProxmoxConfig(chatJid: string): Promise<ProxmoxConfigClearResult> {
  return {
...
function getRequiredProxmoxConfig(chatJid: string): ProxmoxConfig {
...
export async function requestStoredProxmoxApi(
  chatJid: string,
  input: {
    method: string;
    path: string;
...
export async function runStoredProxmoxWorkflow(
  chatJid: string,
