...
export function installWebChannelPrototype(
  ...
  Object.defineProperties(target, {
    ...
    handleLspSession: {
      configurable: true,
      writable: true,
      value: withHttpSurface((service, req: Request) => service.handleLspSession(req)),
    },
    handleLspHandoff: {
      configurable: true,
      writable: true,
      value: withHttpSurface((service, req: Request) => service.handleLspHandoff(req)),
    },
    handleLspGetSettings: {
      configurable: true,
      writable: true,
      value: withHttpSurface((service, req: Request) => service.handleLspGetSettings(req)),
    },
    handleLspUpdateSettings: {
      configurable: true,
      writable: true,
      value: withHttpSurface((service, req: Request) => service.handleLspUpdateSettings(req)),
    },
    handleVncSession: {
      configurable: true,
      writable: true,
    ...
    handleSystemMetrics: {
      configurable: true,
      writable: true,
      value: withHttpSurface((service, req: Request) => service.handleSystemMetrics(req)),
    },
